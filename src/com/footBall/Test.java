...
class Test extends BaseClass{
	...
	public static void main(String[] args) {
		/*
		 * TournamentRegistrationDetails tournamentRegistrationDetails=new
		 * TournamentRegistrationDetails();
		 * createTournment(tournamentRegistrationDetails); TournamentSchedule
		 ...
		 * tournamentRegistrationDetails.startTournamentObject.startTournament(
		 * tournamentSchedule);
		 */
